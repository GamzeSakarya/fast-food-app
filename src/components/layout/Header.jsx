  ...
  return (
    ...
    >
      <div className="container mx-auto text-white flex justify-between items-center h-full ">
        <Logo />
        <nav
          className={`sm:static absolute top-0 left-0 sm:w-auto sm:h-auto w-full h-full h-screen sm:text-white text-black sm:bg-transparent bg-white sm:flex hidden  ${
        ...
        <div className="flex gap-x-2 sm:flex-row flex-col items-center">
          ...
          <Link href="#" className="md:inline-block hidden sm">
            <button className="btn-primary p-4">Order Online</button>
          </Link>
          <button
